...
public class TreasurerDashboard extends JFrame {
    ...
    private void initComponents() {
        ...
        String[] lateFeesColumns = { "Member ID", "Member", "Original Due Date", "Amount Due", "Months Late",
                "Late Fees", "Total Due" };
    ...
    private void setupListeners() {
        ...
        tabbedPane.addChangeListener(e -> {
            ...
            switch (selectedIndex) {
                ...
                case 2:
                    // Refresh reports
                    DefaultTableModel revenueModel = (DefaultTableModel) ((JTable) ((JScrollPane) revenuePanel
                            .getComponent(1)).getViewport().getView()).getModel();
                    loadRevenueData("This Month", revenueModel);

                    DefaultTableModel arModel = (DefaultTableModel) ((JTable) ((JScrollPane) accountsReceivablePanel
                            .getComponent(0)).getViewport().getView()).getModel();
                    loadAccountsReceivableData(arModel);

                    DefaultTableModel balancesModel = (DefaultTableModel) ((JTable) ((JScrollPane) memberBalancesPanel
                            .getComponent(0)).getViewport().getView()).getModel();
    ...
    // Replace the loadLateFees() method in TreasurerDashboard.java with this
    ...
    private void loadLateFees() {
        ...
        try {
            ...
            // Query for members with late fees - using SQLite date functions instead of
            // PERIOD_DIFF
    ...
    // Replace the applyLateFees() method in TreasurerDashboard.java with this
    // SQLite-compatible version
    ...
    private void sendLateFeesNotice(int memberId, String memberName) {
        try {
            ...
            if (emailRs.next()) {
                ...
                emailContent.append("Our records indicate that you have overdue fees totaling $")
                        .append(String.format("%.2f", totalDue)).append(".\n\n");
