...
public class CourtReservationScreen extends JFrame {
    ...
    JComboBox<String> courtComboBox;
    ...
    ArrayList<ParticipantEntry> participants = new ArrayList<>();
    ...
    private void initComponents() {
        ...
        // Time spinner for reservation start time (7:00 AM - 9:00 PM in 30-min
        // increments)
    ...
    public boolean isCourtAvailable(int courtId, LocalDate date, String startTime, String endTime) {
        try {
            Connection conn = dbConnection.getConnection();
            ...
            String st = String.valueOf(cal.getTime().getTime());
            ...
            String et = String.valueOf(cal.getTime().getTime());
