...
public class AdminDashboard extends JFrame {
    ...
    private void setupListeners() {
        ...
        addMemberButton.addActionListener(e -> {
            MemberManagementScreen.MemberDialog dialog = new MemberManagementScreen(currentUser).new MemberDialog(this, "Add New Member", -1);
        ...
        editMemberButton.addActionListener(e -> {
            ...
            if (selectedRow != -1) {
                ...
                MemberManagementScreen.MemberDialog dialog = new MemberManagementScreen(currentUser).new MemberDialog(this, "Edit Member", memberId);
                dialog.setVisible(true);
        ...
        try {
            ...
            switch (dateRange) {
                ...
                case "This Week":
                    ...
                    break;
                case "Next Week":
                    queryBuilder.append("AND r.reservation_date BETWEEN date('now', '+7 day') AND date('now', '+14 day') ");
                    break;
                case "This Month":
    ...
    private void loadCourtUsageData(String timeRange) {
        DefaultTableModel model = (DefaultTableModel) ((JTable) ((JScrollPane) courtUsagePanel.getComponent(1)).getViewport().getView()).getModel();
        model.setRowCount(0);
    ...
    private void loadRevenueData(String timeRange, DefaultTableModel model) {
        ...
        try {
            ...
            // Get late fees
            String lateFeesQuery = "SELECT 'Late Fees' AS category, SUM(amount) AS total FROM LateFees WHERE is_paid = 1 AND " + dateRangeClause.replace("paid_date", "month_applied");
            ...
            // Get guest fees
            String guestFeesQuery = "SELECT 'Guest Fees' AS category, SUM(amount) AS total FROM GuestFees WHERE is_paid = 1 AND " + dateRangeClause.replace("paid_date", "date_applied");
